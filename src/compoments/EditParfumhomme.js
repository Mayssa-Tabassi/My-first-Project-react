...
useEffect(()=>{
  axios.get('http://localhost:3001/ParfumMan/'+id).then(res => {
...
axios.put("http://localhost:3001/ParfumMan/"+id,newProduct)
.then(res => {  
console.log(res);
navigate("/articles")
})   
...
export default EditParfumhomme;